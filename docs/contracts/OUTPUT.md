...
Version 0.1 does not claim identical behavior on every filesystem, protection against hostile concurrent path manipulation, or support for filesystems without hard links. Release testing covers the documented release targets and representative native filesystems.
