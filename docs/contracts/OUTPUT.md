# Version 0.6 Output Contract

> [!IMPORTANT]
> This is the implemented version 0.6 output contract.

## Boundary

This document defines the portable output guarantees for version 0.6. It uses
